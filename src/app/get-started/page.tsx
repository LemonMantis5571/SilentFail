    ...
    <div className="min-h-screen bg-[#020817] text-slate-300 font-sans selection:bg-indigo-500/30 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-16">
        ...
        <div className="grid gap-12 relative">
          ...
          <div className="hidden md:block absolute left-[27px] top-8 bottom-8 w-0.5 bg-linear-to-b from-indigo-500/50 via-slate-800 to-transparent -z-10" />
          ...
          <div className="relative pl-0 md:pl-20 group">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-400 leading-relaxed max-w-10/12 md:max-w-none">
              ...
              <Card className="bg-[#0B1121] border-slate-800 shadow-lg w-fit md:w-auto max-w-10/12 md:max-w-none">
                <CardContent className="p-6 flex flex-row items-center gap-6">
                  <div className="flex flex-col gap-1 items-center justify-center p-4 bg-slate-900/50 rounded-lg border border-slate-800 md:w-24">
                    <Clock className="h-6 w-6 text-indigo-400" />
                    <span className="text-xs font-mono text-slate-400">1440m</span>
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-medium text-white">Daily Database Backup</span>
                      <Badge variant="outline" className="text-[10px] h-5 border-emerald-500/30 text-emerald-400 bg-emerald-500/5">
                        Healthy
                      </Badge>
                    </div>
                    <p className="text-xs text-slate-500">Monitoring every 24 hours with 30m grace period</p>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="relative pl-0 md:pl-20 group">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg bg-[#020617] border border-slate-800 overflow-hidden font-mono text-sm relative group/code max-w-10/12 md:max-w-none">
                <div className="flex items-center justify-between px-4 py-2 border-b border-slate-800 bg-slate-900/50">
                  <span className="text-xs text-slate-500">backup-script.sh</span>
                  <Terminal className="h-3 w-3 text-slate-500" />
                </div>
                <div className="p-4 space-y-2 text-slate-300 max-w-10/12 md:max-w-none">
          ...
          <div className="relative pl-0 md:pl-20 group">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-10/12 md:max-w-none">
        ...
        <div className="text-center pt-8">
          <Link href="/dashboard">
            <Button size="lg" className="h-14 px-10 text-lg bg-blue-700 hover:bg-indigo-500 text-white shadow-xl shadow-indigo-500/20 group">
              Go to Dashboard
